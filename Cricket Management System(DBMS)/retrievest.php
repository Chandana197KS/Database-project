...
<form id="DataForm" action="update_deletest.php" method="post"></form>
...
$countQuery="SELECT count(*) as cnt FROM sponser_team";
...
$sql1="SELECT * FROM sponser_team LIMIT 1 OFFSET $a";
