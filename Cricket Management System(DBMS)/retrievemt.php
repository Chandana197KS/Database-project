...
<form id="DataForm" action="update_deletemt.php" method="post"></form>
...
$countQuery="SELECT count(*) as cnt FROM match_team";
...
$sql1="SELECT * FROM match_team LIMIT 1 OFFSET $a";
