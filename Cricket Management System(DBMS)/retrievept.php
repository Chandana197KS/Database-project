...
<form id="DataForm" action="update_deletept.php" method="post"></form>
...
$countQuery="SELECT count(*) as cnt FROM player_team";
...
$sql1="SELECT * FROM player_team LIMIT 1 OFFSET $a";
...
<tr><td><font color=white><b>T_id</td><td><input type="text" name="tid" value="<?php echo $row["t_id"]; ?>" form="DataForm"/></td></tr>
