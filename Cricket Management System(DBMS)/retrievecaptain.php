...
<form id="DataForm" action="update_deletecaptain.php" method="post"></form>
...
$countQuery="SELECT count(*) as cnt FROM captain";
...
$sql1="SELECT * FROM captain LIMIT 1 OFFSET $a";
...
?>
<tr><td><font color=white><b>Captain_id</td><td><input type="text" name="capid" value="<?php echo $row["cap_id"];?>" form="DataForm"/></td></tr>
<tr><td><font color=white><b>Captain_name</td><td><input type="text" name="capname" value="<?php echo $row["cap_name"]; ?>" form="DataForm"/></td></tr>
<tr><td><font color=white><b>Team_id</td><td><input type="text" name="tid" value="<?php echo $row["t_id"]; ?>" form="DataForm"/></td></tr>
<?php
}
?>
